...
<div class="single_widgets widget_thumb_post">
    ...
    <ul>
        <li>
            <span class="left">
                <img src=" <?php echo get_template_directory_uri() . '/assets/img/blog-sm-01.jpg' ?>" alt="" class="">
            </span>
            <span class="right">
        ...
        <li>
            <span class="left">
                <img src=" <?php echo get_template_directory_uri() . '/assets/img/blog-sm-02.jpg' ?>" alt="" class="">
            </span>
            <span class="right">
        ...
        <li>
            <span class="left">
                <img src=" <?php echo get_template_directory_uri() . '/assets/img/blog-sm-03.jpg' ?>" alt="" class="">
            </span>
            <span class="right">
