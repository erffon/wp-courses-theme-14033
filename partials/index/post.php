                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="single.html" style="background-image:url(<?php echo get_template_directory_uri() . '/assets/img/course-1.jpg' ?>"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="#">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                                    <li class="d-flex align-items-center"></i>وحید صالحی</li>
                                    <li class="video d-flex align-items-center"><i class="ti-video-clapper"></i>ویدئو</li>
                                    <li class="video d-flex align-items-center"><i class="ti-eye"></i>321</li>
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="#" style="background-image:url(<?php echo get_template_directory_uri() . '/assets/img/course-3.jpg' ?>"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="single.html">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="single.html" style="background-image:url(<?php echo get_template_directory_uri() . '/assets/img/course-6.jpg' ?>"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="#">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="single.html" style="background-image:url(<?php echo get_template_directory_uri() . '/assets/img/course-4.jpg' ?>"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="#">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
                    ...
                    <div class="singles_items ">
                        <div class="edu_cat">
                            <div class="pic">
                                <div class="topic_level bg-info text-white">سطح : متوسط</div>
                                <div class="topic_cat bg-warning text-white">جاوااسکریپت</div>
                                <a class="pic-main" href="#" style="background-image:url(<?php echo get_template_directory_uri() . '/assets/img/course-2.jpg' ?>"></a>
                            </div>
                            <div class="edu_data singles_items_border_bottom">
                                <h4 class="title"><a href="single.html">پلاگین نویسی وردپرس</a></h4>
                                <ul class="meta d-flex mt-4">
