<!-- ============================ Hero Banner  Start================================== -->
<div class="image-cover hero_banner hero-inner-2 shadow rlt" style="background:url(<?php echo get_template_directory_uri() . '/assets/img/banner-2.jpg' ?>) no-repeat;" data-overlay="7">
    <div class="container">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12 br-right">
                                <div class="form-group">
                                    <div class="input-with-icon">
                                        ...
                                        <img src="<?php echo get_template_directory_uri() . '/assets/img/search.svg' ?>" class="search-icon" alt="" />
                                    </div>
                                </div>
                            </div>
