...
function register_assets()
{
    ...
    wp_register_script('bootstrap-js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', '', '1.0.0', 'true');
    wp_register_script('select2js', get_template_directory_uri() . '/assets/js/select2.min.js', '', '1.0.0', 'true');
